# Buckley Facility Operations Monitor — Owner Reference

This file is the detailed technical reference for maintaining the dashboard. It explains the data sources, APIs, filtering, thresholds, deployment, and system behavior. It is not intended to be the public-facing README.
